...
from mvc.views.renamer.parsers import ParserWithRegexSegments, YearMonthDayParser, TimeParser
...
class ParserHEIC(ClassWithTag, ParserWithRegexSegments):
    ...
    def __init__(self, file_extension='.heic'):
        ...
        self.reg_segments = ['IMG_', ParserHEIC.Part1(), file_extension]
...
class ParserHEIC2(ClassWithTag, ParserWithRegexSegments):
    ...
    def __init__(self, file_extension='.heic'):
        super().__init__(file_extension)
        self.reg_segments = [ParserHEIC.Part1(), file_extension]
