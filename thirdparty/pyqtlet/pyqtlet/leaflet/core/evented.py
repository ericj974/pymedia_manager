...
class Evented(QObject):
    ...
    def __init__(self, mapWidget=None):
        ...
        Evented.mapWidget.page.titleChanged.connect(lambda: print('title changed'))
    ...
    def getJsResponse(self, js, callback):
        ...
        Evented.mapWidget.page.runJavaScript(js, callback)
    ...
    def runJavaScript(self, js):
        ...
        Evented.mapWidget.page.runJavaScript(js)
    ...
    def _createJsObject(self, leafletJsObject):
        ...
        _id = '{name}Object'.format(name=self.jsName)
        Evented.mapWidget.channel.registerObject(_id, self)
